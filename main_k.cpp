...
int main(int argc, char *argv[])
{
    ...
    double K [11] = {50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150}; // 100;
    double F = 100;
    double sigma = 0.4;
    ...
    for (int r = 0; r < 11; r++)
    {
        ...
        std::ofstream myfile;
        std::string name = "time_control_k_" + std::to_string(K[r]) + "_single_core.csv";
        myfile.open (name);
        ...
        {        
            ...
            avg_payoff = start_exp(
                n_assets, T, discount_f, rho_ij, K[r], F, sigma, wi, paths, path_len
            );
